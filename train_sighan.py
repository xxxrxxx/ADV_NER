    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            with tf.variable_scope('ner_model',reuse=None,initializer=initializer):
                m=GRUsighan_model.TransferModel(setting,tf.cast(embedding,tf.float32),adv=True,is_train=True)
                m.multi_task()
                    ...
                    for j in range(2):
                        if j==0:
                            ...
                            if step % 100 ==0:
                                ...
                                print(temp)
                            current_step = step
                            if current_step % 500 == 0 and current_step > 3000 and current_step < 18000:
